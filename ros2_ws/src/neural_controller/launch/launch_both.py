...
def generate_launch_description():
    #
    # 1. Declare a boolean launch argument 'use_mujoco'
    #
    declare_sim_arg = DeclareLaunchArgument(
        name="sim",
        default_value="False",
        description="Add `sim:=True` to run the robot in the Mujoco simulator, otherwise the default value of False will run the real robot.",
    )
