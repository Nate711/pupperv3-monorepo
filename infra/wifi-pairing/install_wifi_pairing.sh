...
echo "== 3/6 comitup-web customization (saved-network priority page) =="
...
echo "== 4/6 pupper-pairing helper + sudoers =="
...
echo "== 5/6 NetworkManager loopback patch (fixes comitup crash loop on NM 1.42+) =="
sudo python3 "$SCRIPT_DIR/patch_networkmanager_loopback.py"

echo "== 6/6 enable comitup =="
